...
create_clock -period 3.330 -name cxph_gth_clk -waveform {0.000 1.665} [get_ports cxph_gth_clk_p]
set_multicycle_path -setup -from [get_pins */*/iMemorySizeChecker/SizeCheckDone_reg/C] 8
set_multicycle_path -hold -end -from [get_pins */*/iMemorySizeChecker/SizeCheckDone_reg/C] 7
set_multicycle_path -setup -from [get_pins */*/iMemorySizeChecker/FullSizeMem_reg/C] 8
set_multicycle_path -hold -end -from [get_pins */*/iMemorySizeChecker/FullSizeMem_reg/C] 7
set_multicycle_path -setup -from [get_ports {io_ext1[3]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[3]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[4]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[4]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[5]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[5]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[6]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[6]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[7]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[7]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[8]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[8]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[9]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[9]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[10]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[10]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[11]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[11]}] 4
set_multicycle_path -setup -from [get_ports {io_ext1[12]}] 5
set_multicycle_path -hold -end -from [get_ports {io_ext1[12]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[3]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[3]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[4]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[4]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[5]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[5]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[6]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[6]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[7]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[7]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[8]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[8]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[9]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[9]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[10]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[10]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[11]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[11]}] 4
set_multicycle_path -setup -start -to [get_ports {io_ext1[12]}] 5
set_multicycle_path -hold -to [get_ports {io_ext1[12]}] 4
...
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[4]_inst/T}] -to [get_ports {io_ext1[2]}]
set_false_path -from [get_ports {io_ext1[2]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[4]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[3]_inst/T}] -to [get_ports {io_ext1[3]}]
set_false_path -from [get_ports {io_ext1[3]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[3]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[4]_inst/T}] -to [get_ports {io_ext1[4]}]
set_false_path -from [get_ports {io_ext1[4]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[4]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[5]_inst/T}] -to [get_ports {io_ext1[5]}]
set_false_path -from [get_ports {io_ext1[5]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[5]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[6]_inst/T}] -to [get_ports {io_ext1[6]}]
set_false_path -from [get_ports {io_ext1[6]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[6]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[7]_inst/T}] -to [get_ports {io_ext1[7]}]
set_false_path -from [get_ports {io_ext1[7]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[7]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[8]_inst/T}] -to [get_ports {io_ext1[8]}]
set_false_path -from [get_ports {io_ext1[8]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[8]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[9]_inst/T}] -to [get_ports {io_ext1[9]}]
set_false_path -from [get_ports {io_ext1[9]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[9]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[10]_inst/T}] -to [get_ports {io_ext1[10]}]
set_false_path -from [get_ports {io_ext1[10]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[10]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[11]_inst/T}] -to [get_ports {io_ext1[11]}]
set_false_path -from [get_ports {io_ext1[11]}] -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[11]_inst/T}]
set_false_path -through [get_pins {iCoaxlinkCore/iExtIOBusMux/EXTIO_bus_IOBUF[12]_inst/T}] -to [get_ports {io_ext1[12]}]
...
set_max_delay -datapath_only -from [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/ul_ce_t_reg/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/ul_ce_s_reg[2]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/*/*/MULTILINK_GEN[*].LINK_INST/tport_ul_data_reg[*]/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/ul_data_s_1_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/*/*/MULTILINK_GEN[*].LINK_INST/tport_ul_k_reg/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/ul_k_s_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/*/*/CSR_INST/regs_up_stream_mode_reg[*][*]/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/UPLINK_TX_INST/ui_ce_reg/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/*/*/CSR_INST/regs_up_stream_mode_reg[*][*]/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/UPLINK_TX_INST/ui_presc_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/*/*/CSR_INST/regs_up_stream_mode_reg[*][*]/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/UPLINK_TX_INST/tx_sr_reg[*]/R}] 8.000
set_max_delay -datapath_only -from [get_pins {*/*/*/CSR_INST/regs_tportcsr_reg[*][*]/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/UPLINK_TX_INST/ui_presc_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/*/*/CSR_INST/regs_tportcsr_reg[*][*]/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].TPORT_UPLINK_INST/UPLINK_TX_INST/ui_ce_reg/D}] 8.000
...
set_max_delay -datapath_only -from [get_pins {*/iVideo/FB_INST/axi_read_sts_reg[*]/C}] -to [get_pins {*/iVideo/FB_INST/axi_read_sts_clk250_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/iVideo/FB_INST/axi_write_sts_reg[*]/C}] -to [get_pins {*/iVideo/FB_INST/axi_write_sts_clk250_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/iVideo/fb_MemDWLevel_d1_reg[*]/C}] -to [get_pins {*/iVideo/Framestore_MemDWLevel_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins {*/iVideo/STM_PROC_INST/iStmParser/s2_hdr_img_SourceTag_reg[*]/C}] -to [get_pins {*/iVideo/VideoEventSignaling_reg[ImgSourceTag][*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins */iTimestamp/Inst_TimeStamp/bl.DSP48E_2/DSP_OUTPUT_INST/CLK] -to [get_pins {*/iVideo/Timstamp_aclk_reg[*]/D}] 8.000
set_max_delay -datapath_only -from [get_pins */iTimestamp/toggle_clk125_reg/C] -to [get_pins {*/iTimestamp/toggle_user_clk_s_reg[2]/D}] 8.000
