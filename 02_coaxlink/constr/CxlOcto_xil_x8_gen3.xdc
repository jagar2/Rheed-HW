...
set_property QPLL1_CFG2 16'h0040 [get_cells -hierarchical -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE3_COMMON && PARENT =~ "*pcie*" }]
set_property QPLL1_LOCK_CFG 16'h21E8 [get_cells -hierarchical -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE3_COMMON && PARENT =~ "*pcie*" }]
set_property QPLL1_LOCK_CFG_G3 16'h21E8 [get_cells -hierarchical -filter { PRIMITIVE_TYPE =~ ADVANCED.GT.GTHE3_COMMON && PARENT =~ "*pcie*" }]
...
####################################################################################
# Constraints from file : 'CxlOcto_timing_common.xdc'
####################################################################################
