...
module gaussian_concatenate1d_array_array_array_ap_fixed_16_6_5_3_0_4u_config30_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (layer30_out_full_n == 1'b0) | (layer27_out_empty_n == 1'b0) | (layer26_out_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign layer30_out_din = {{layer27_out_dout}, {layer26_out_dout}};

assign start_out = real_start;

endmodule //gaussian_concatenate1d_array_array_array_ap_fixed_16_6_5_3_0_4u_config30_s
