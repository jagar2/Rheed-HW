...
entity gaussian_fifo_w184_d1_S is 
    generic (
...
architecture rtl of gaussian_fifo_w184_d1_S is
...
------------------------Component----------------------
    component gaussian_fifo_w184_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 184;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
...
begin
----------------------- Instantiation -----------------------
    U_gaussian_fifo_w184_d1_S_ShiftReg : gaussian_fifo_w184_d1_S_ShiftReg
    generic map (
...
entity gaussian_fifo_w184_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 184;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end gaussian_fifo_w184_d1_S_ShiftReg;

architecture rtl of gaussian_fifo_w184_d1_S_ShiftReg is
