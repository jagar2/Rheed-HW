...
entity gaussian_concatenate1d_array_array_array_ap_fixed_16_6_5_3_0_4u_config30_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gaussian_concatenate1d_array_array_array_ap_fixed_16_6_5_3_0_4u_config30_s is 
...
begin
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, layer26_out_empty_n, layer27_out_empty_n, layer30_out_full_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (layer30_out_full_n = ap_const_logic_0) or (layer27_out_empty_n = ap_const_logic_0) or (layer26_out_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    layer26_out_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    layer27_out_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, layer27_out_empty_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    layer27_out_read_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    layer30_out_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, layer30_out_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    layer30_out_din <= (layer27_out_dout & layer26_out_dout);

    layer30_out_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
