...
module folo_zeropad2d_cl_array_array_ap_ufixed_8_0_4_0_0_6u_config19_Pipeline_CopyMain (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((layer19_out_full_n == 1'b0) | (layer7_out_empty_n == 1'b0));
end
...
assign icmp_ln65_fu_62_p2 = ((ap_sig_allocacmp_j_1 == 7'd80) ? 1'b1 : 1'b0);

assign j_2_fu_68_p2 = (ap_sig_allocacmp_j_1 + 7'd1);

assign layer19_out_din = layer7_out_dout;

endmodule //folo_zeropad2d_cl_array_array_ap_ufixed_8_0_4_0_0_6u_config19_Pipeline_CopyMain
