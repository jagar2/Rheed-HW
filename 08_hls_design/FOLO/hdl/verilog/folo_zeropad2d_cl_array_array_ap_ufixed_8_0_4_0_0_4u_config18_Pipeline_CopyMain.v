...
module folo_zeropad2d_cl_array_array_ap_ufixed_8_0_4_0_0_4u_config18_Pipeline_CopyMain (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if (((icmp_ln65_fu_62_p2 == 1'd1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1_grp1 = ((layer18_out_full_n == 1'b0) | (layer4_out_empty_n == 1'b0));
end

always @ (*) begin
    ap_condition_165 = ((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign icmp_ln65_fu_62_p2 = ((j_fu_36 == 8'd160) ? 1'b1 : 1'b0);

assign j_4_fu_68_p2 = (j_fu_36 + 8'd1);

assign layer18_out_din = layer4_out_dout;

endmodule //folo_zeropad2d_cl_array_array_ap_ufixed_8_0_4_0_0_4u_config18_Pipeline_CopyMain
